...
root.iconbitmap('video.png')

my_image1 = ImageTk.PhotoImage(Image.open("short.png"))
my_image2 = ImageTk.PhotoImage(Image.open("student.png"))
my_image3 = ImageTk.PhotoImage(Image.open("gun.png"))
my_image4 = ImageTk.PhotoImage(Image.open("report.png"))
my_image5 = ImageTk.PhotoImage(Image.open("hand.png"))
